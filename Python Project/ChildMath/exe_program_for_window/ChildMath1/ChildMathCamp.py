...
if __name__ == "__main__":
    ...
    #********************************** Const Parameter ******************************************#
    WELCOME_GIF     = r".\welcome.gif"     # 欢迎界面
    SCORE_000       = r".\fen_000.gif"     # 评判界面：得了0分
    SCORE_100       = r".\fen_100.gif"     # 评判界面：得了100分
    SCORE_060       = r".\fen_060.gif"     # 评判界面：得了60分
    SCORE_059       = r".\fen_059.gif"     # 评判界面：得了59分

    WAIT_TIME       = 3000              # 界面的持续时间： 2000 毫秒
